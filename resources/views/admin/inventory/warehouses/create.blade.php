                        ...
                        <div class="card-content">
                            <div class="card-body pt-0">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group parent" style="">
                                            <h6 class="form-label"><span>Kode Gudang</span></h6>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group parent" style="">
                                            <h6 class="form-label"><span>Nama Gudang</span></h6>
                                            <input name="description" type="text" id="description"
                                                placeholder="Nama Gudang" class="form-control form-control-lg "
                                                value="">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group parent" style="">
                                            <h6 class="form-label"><span>Telpon Gudang</span></h6>
                                            <input name="description" type="text" id="description"
                                                placeholder="Telepon Gudang" class="form-control form-control-lg "
                                                value="">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group parent" style="">
                                            <h6 class="form-label"><span>Telpon PIC</span></h6>
                                            <input name="description" type="text" id="description"
                                                placeholder="Telpon PIC" class="form-control form-control-lg "
                                                value="">
                                        </div>
                                    </div>
                                    <div class="col-12">
