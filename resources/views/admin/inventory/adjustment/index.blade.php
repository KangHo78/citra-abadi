                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row align-items-center">
                                    <div class="col-lg-2 col-3">
                                        <label class="col-form-label" for="last-name">Gudang</label>
                                    </div>
                                    <div class="col-lg-10 col-9">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-sm-9 col-9">
                        ...
                        <div class="buttons">
                            <a href="{{ route('adjustment.stok_opname') }}"
                                class="btn btn-outline-info rounded-pill float-end">Buat stok opname</a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="btn-group mb-1">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                <a href="{{route('adjustment.show',$i)}}"
                                                    class="dropdown-item">
                                                    <i class="bi bi-eye text-primary"></i>
                                                    <b class="p-2">Lihat</b>
                                                </a>
                                                <a href="{{route('adjustment.edit',$i)}}"
                                                    class="dropdown-item">
                                                    <i class="bi bi-pencil text-warning"></i>
                                                    <b class="p-2">Ubah</b>
                                                </a>
                                                <a href="{{route('adjustment.print',$i)}}"
                                                    class="dropdown-item">
