                    ...
                    <div class="col-sm-9 col-9">
                        <div class="buttons">
                            <a href="{{ route('vendor.create') }}"
                                class="btn btn-outline-info rounded-pill float-end">Buat vendor baru</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>081111111</td>
                                <td>Jl. Test No. 1, Kota Mojokerto</td>
                                    ...
                                    <div class="btn-group mb-1">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                <a href="{{route('vendor.show',$i)}}"
                                                    class="dropdown-item">
                                                    <i class="bi bi-eye text-primary"></i>
                                                    <b class="p-2">Lihat</b>
                                                </a>
                                                <a href="{{route('vendor.edit',$i)}}"
                                                    class="dropdown-item">
