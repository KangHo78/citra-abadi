                ...
                <div class = "invoice-head">
                    ...
                    <div class = "invoice-head-middle">
                        <div class = "invoice-head-middle-left text-start">
                            <p><span class = "text-bold">Tanggal</span> </p>
                        </div>
                        <div class = "invoice-head-middle-right text-end">
                            <p>
                                <spanf class = "text-bold">{{date('d F Y')}}</span>
                            </p>
                        </div>
                    </div>
                    <div class = "hr"></div>
                ...
                <div class = "overflow-view">
                    <div class = "invoice-body" id="invoice-body">
                        <table>
                            <thead>
                                <tr>
                                    <td class = "text-bold">Transaksi</td>
                            ...
                            <tbody>
                                <tr>
                                    <td>Penjualan</td>
                                    <td class = "text-end">Rp. {{number_format(12000*10,0,'.',',')}}</td>
                                </tr>
                                <tr>
                                    <td>Hpp</td>
                                    <td class = "text-end">Rp. {{number_format(10000*10,0,'.',',')}}</td>
                                </tr>
                            </tbody>
                        </table>
                        <div class = "invoice-body-bottom">
                            <div class = "invoice-body-info-item">
                                ...
                                <div class = "info-item-td text-end">Rp. 20.000</div>
                            </div>
                        </div>
                    </div>
                </div>
