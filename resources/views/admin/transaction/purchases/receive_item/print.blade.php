                ...
                <div class = "invoice-head">
                    ...
                    <div class = "invoice-head-middle">
                        ...
                        <div class = "invoice-head-middle-right text-end">
                            <p>
                                <spanf class = "text-bold">Receipt Code: </span>16789
                            </p>
                            <p>
                                <spanf class = "text-bold">Form Code: </span>FC16789
                            </p>
                        </div>
                    </div>
                    <div class = "hr"></div>
                    <div class = "invoice-head-bottom">
                        <div class = "invoice-head-bottom-left">
                            ...
                            <ul>
                                <li class = 'text-bold'>Warehouse:</li>
                                <li>Smith Rhode Warehouses</li>
                                <li>15 Good St, Manchester</li>
                                <li>PP12 43JL</li>
                                <li>United Kingdom</li>
                            </ul>
                            <br>
                            <ul>
                                <li class = 'text-bold'>Nama Penerima:</li>
                                <li>Smith</li>
                        ...
                        <div class = "invoice-head-bottom-right">
                            ...
                            <br>
                            <ul class = "text-end">
                                <li class = 'text-bold'>Nama Pengirim:</li>
                                <li>Agus</li>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>10</td>
                                    <td class = "text-end">SN1939393</td>
                                </tr>
                                <tr>
                                    <td>Development</td>
