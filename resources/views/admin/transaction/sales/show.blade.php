                                        ...
                                        <div class="form-group pb-1 parent">
                                            ...
                                            <div class="input-group mb-1">
                                                ...
                                                <input name="date" id="date" placeholder="Date"
                                                    class="flatpicker date validation required form-control form-control-lg flatpickr-input"
                                                    value="2024-02-02" readonly="" style="background-color:#eeeeee"
                                                    onchange="generateCode()" type="hidden"><input
                                                    class="flatpicker date validation required  form-control form-control-lg flatpicker date validation required   form-control input"
