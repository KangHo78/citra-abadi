<x-app-layout-frontend>
    ...
    <div class="container bootstrap snippets bootdey" style="padding-bottom:100px">
        <div class="row">
            <div class="profile-nav col-md-3 pb-5">
                <div class="panel">
                    ...
                    <ul class="">
                        <li class="active" style="padding: 10px;background-color:blanchedalmond">
                        ...
                        <li style="padding: 10px">
                            <a href="#"> <i class="fa fa-calendar"></i> 
                                Histori Pembelian
                                <span class="label label-warning pull-right r-activity">9</span></a>
                        </li>
                    </ul>
                </div>
            </div>
